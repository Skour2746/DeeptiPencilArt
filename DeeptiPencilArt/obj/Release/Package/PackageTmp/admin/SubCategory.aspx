<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="DeeptiPencilArt.admin.WebForm2" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="forms-sample">
                                <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddcategory" runat="server" class="form-control" DataTextField="CategoryName" DataValueField="id">
                                            </asp:DropDownList>

                                        </div>
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Sub-Category</label>
                                    <asp:TextBox ID="txt_Category" type="text" class="form-control" placeholder="Sub-Category" runat="server"></asp:TextBox>
                                </div>
                                ...
                                <asp:Button ID="Button1" type="submit" class="btn btn-primary me-2" OnClick="Button1_Click" runat="server" Text="Submit" />
                                        ...
                                        <asp:ListView ID="lv_category" OnItemCommand="Lv_category_ItemCommand" OnItemDeleting="Lv_category_ItemDeleting" OnItemEditing="Lv_category_ItemEditing" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><img src="../images1/SubCategory/<%# Eval("image") %>" /></td>
                                                    <td><%# Eval("status") %></td>
                                                    <td>
