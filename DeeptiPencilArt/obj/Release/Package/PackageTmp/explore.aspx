    ...
    <section class="content-section" data-background="#fffbf7">
        <div class="container">
            <div class="row justify-content-center">
                 <div class="col-lg-12">
                    <asp:DropDownList ID="ddlCategoryFilter" runat="server" CssClass="fbtn" AutoPostBack="true" OnSelectedIndexChanged="DdlCategoryFilter_SelectedIndexChanged">
                      
                        <asp:ListItem Text="Filter with Category" Cssclass="submenu" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Sketch" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Mandala Art" Value="3"></asp:ListItem>
                        <asp:ListItem Text="Coloured" Value="4"></asp:ListItem>
                    </asp:DropDownList>
                     
                    <asp:DropDownList ID="ddsubcategory" runat="server" CssClass="fbtn">
